...
def main():
    ...
    p_reply.add_argument("--note-url", required=True, help="Note URL to open")
    p_reply.add_argument("--text", default=None, help="Reply text")
    p_reply.add_argument("--text-file", default=None, help="Read reply text from file")
